 ...
 *
 * Modifications : Alexandre Vanhecke (Xephi)
 */
namespace EpiRadio\Utils;
...
class LoremIpsum
{
   ...
   *          string or array of HTML tags to wrap output with
   * @param boolean $array
   *          whether an array or a string should be returned
   ...
   *          the sentences we would like to punctuate
   */
